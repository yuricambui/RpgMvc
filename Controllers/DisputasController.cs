...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://yuricambui.somee.com/RpgApi/Disputas/";
        [HttpGet]
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://yuricambui.somee.com/RpgApi/Personagens/GetAll";
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://yuricambui.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades";              
